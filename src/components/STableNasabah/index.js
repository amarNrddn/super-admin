...
const TABLE_HEAD = ["NO", "Kode Nasabah", "Nama Nasabah", "RT", 'RW', 'Alamat', 'No Telp', 'Saldo', ''];
    ...
    return (
        <Card className="h-full w-full overflow-scroll pb-[10rem]">
            <table className="w-full min-w-max table-auto text-left">
                ...
                <tbody>
                    {TABLE_ROWS.map(({ id, kode, nama, rt, rw, alamat, notelp, saldo }, index) => (
